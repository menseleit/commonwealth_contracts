...
which(is.na(all_data$`Start Date`), arr.ind = TRUE)
all_data <- all_data[-c(2798542,2798516,798556, 2952486, 2957889, 3141406, 3256378, 3299451, 3338535, 3370873,2278016, 2278017, 2278018, 2278019, 2278020, 2278021, 2667304, 2756041, 3195028, 3328345, 3338506, 3370843, 2798555, 2952484, 2957886, 3141402, 3256374, 3299446,1713858, 2798573, 2952506, 2957912, 3141432, 3256410, 3299486, 2278015, 2278016, 2667309, 2756046, 3195041, 3328362, 3338523, 3370860),]
...
#If this doesn't work it may be because the above rows have changed.
...
all_data <- all_data[-c(206948,  221529,  287645,  289034,  440780,  546038,  546039,  554503,  554506,  577963,  579053, 
                        851873,  866453,  932555, 933944, 1085680, 1190960, 1190961, 1199430 ,1199433, 1222898, 1223983),]
